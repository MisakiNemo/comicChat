...
import ChatItem from "@/components/Chat/chatSide/chatList/chatItem/chatItem.tsx";
...
const ChatList = () => {
  const chatList: ChatItemType[] = [
    ...
    },
    {
      ...
      userName: "John Doe",
      lastMessage:
        "Hey, what's asdasdaskdninup?asdsdbajsbdsbfkasjnjckasnkjasbca",
  ...
  return (
    <div className={"h-full w-full bg-red-100"}>
      <div className={"h-10 flex "}>
        <Input
          className={
            " h-full w-4/5 border-t-0 border-l-0 border-b-0 bg-sky-400 searchInput"
          }
          placeholder={"Search"}
        />
      ...
      <div className={"ContactList max-h-screen overflow-hidden"}>
        <Menu
          ...
          className={"h-full w-full chatMenu "}
          mode={"inline"}
        >
